...
mp = {
# format is "classAlias" : Course(name of course,id,link,pattern=defaultPattern,numberofMatches=1)
...
# by default matches only one link,can be changed with numberofMatches variable
    "ds" :  Course("Data Structures","325364815331",numberofMatches=2),
    ...
    "ds_lab" :  Course("Data Structures Lab","325364815331",numberofMatches=2)
